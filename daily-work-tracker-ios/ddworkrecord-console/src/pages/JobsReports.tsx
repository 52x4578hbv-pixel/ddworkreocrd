    ...
    >
      ...
      <div style={{ marginTop: 18, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 12 }}>
        <div style={{ padding: 12, border: `2px solid ${theme.text}`, borderRadius: theme.radiusMd, background: theme.surface }}>
          <div style={{ color: theme.muted2, fontWeight: 900, fontSize: 12 }}>Jobs workdays</div>
          <div style={{ marginTop: 6, fontWeight: 1000, fontSize: 24 }}>{totals.jobCount}</div>
        </div>

        <div style={{ padding: 12, border: `2px solid ${theme.text}`, borderRadius: theme.radiusMd, background: theme.surface }}>
          <div style={{ color: theme.muted2, fontWeight: 900, fontSize: 12 }}>Total job hours</div>
          <div style={{ marginTop: 6, fontWeight: 1000, fontSize: 24 }}>{totals.totalHours}</div>
        </div>

        <div style={{ padding: 12, border: `2px solid ${theme.text}`, borderRadius: theme.radiusMd, background: theme.surface }}>
          <div style={{ color: theme.muted2, fontWeight: 900, fontSize: 12 }}>Complete hours</div>
          <div style={{ marginTop: 6, fontWeight: 1000, fontSize: 24 }}>{totals.completeHours}</div>
        </div>

        <div style={{ padding: 12, border: `2px solid ${theme.text}`, borderRadius: theme.radiusMd, background: theme.surface }}>
          <div style={{ color: theme.muted2, fontWeight: 900, fontSize: 12 }}>Return required hours</div>
